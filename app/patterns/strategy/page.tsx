    ...
    <div className="flex flex-col w-full max-w-6xl mx-auto px-4 py-12">
      <div className="mb-10">
        ...
        <p className="text-lg text-slate-600 max-w-3xl">
          ...
          It lets the algorithm vary independently from clients that use it. It's essentially "plug and play" behavior!
        </p>
      </div>
      ...
      <div className="mt-12 bg-indigo-50 rounded-2xl p-8 border border-indigo-100">
        ...
        <ul className="space-y-3 text-indigo-800">
          <li className="flex items-start">
            ...
            <span>The <strong>Context</strong> (e.g., a Shopping Cart) needs to perform an action but the rules for it can change (e.g., payment methods).</span>
          </li>
          <li className="flex items-start">
            ...
            <span>Instead of putting all rules in one giant <code>if/else</code> statement, the Context delegates the work to a <strong>Strategy Interface</strong>.</span>
          </li>
          <li className="flex items-start">
            ...
            <span>You create multiple Concrete Strategies (CreditCard, PayPal, Crypto). The Client simply "plugs in" whichever class it wants to use at runtime!</span>
          </li>
        </ul>
      </div>
      ...
      <div className="mt-12 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        ...
        <p className="text-slate-600 mb-4">
          Here is how you inject different payment strategies into a shopping cart using the Strategy Pattern.
        </p>
